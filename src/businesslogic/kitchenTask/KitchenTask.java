...
public class KitchenTask {
    ...
    private ArrayList<KitchenShift> kitchenShifts;
    private User cook;
    ...
    private static void updateTaskUnassigned(KitchenTask task) {
    ...
    public void setKitchenShifts(ArrayList<KitchenShift> kitchenShifts) {
    ...
    public void setProcedure(KitchenProcedure procedure) {
